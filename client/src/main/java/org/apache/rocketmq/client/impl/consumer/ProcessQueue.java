...
public class ProcessQueue {
     ...
     */
    /**
     * 移除消费超时的信息，默认超过15分钟未消费的消息将延迟3个延迟级别再消费
     * @param pushConsumer
     */
    ...
    /**
     * 获取当前消息最大间隔，getMaxSpan()并不能说明ProcessQueue中包含的消息个数，
    ...
    /**
     * 将consumingMsgOrderlyTreeMap所有消息重新放入msgTreeMap，并且清除consumingMsgOrderlyTreeMap
     */
